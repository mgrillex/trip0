  ...
  test("POST /patients", async () => {
    await request(app.getHttpServer())
      ...
      .expect({
        ...
        leavingDate: CREATE_RESULT.leavingDate.toISOString(),
      ...
      .expect([
        {
          ...
          leavingDate: FIND_MANY_RESULT[0].leavingDate.toISOString(),
  ...
  test("GET /patients/:id existing", async () => {
    await request(app.getHttpServer())
      ...
      .expect({
        ...
        leavingDate: FIND_ONE_RESULT.leavingDate.toISOString(),
