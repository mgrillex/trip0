...
@InputType()
class IngredientCreateNestedManyWithoutDepartmentsInput {
...
export { IngredientCreateNestedManyWithoutDepartmentsInput as IngredientCreateNestedManyWithoutDepartmentsInput };
