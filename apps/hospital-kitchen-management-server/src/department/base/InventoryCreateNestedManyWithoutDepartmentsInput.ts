...
@InputType()
class InventoryCreateNestedManyWithoutDepartmentsInput {
...
export { InventoryCreateNestedManyWithoutDepartmentsInput as InventoryCreateNestedManyWithoutDepartmentsInput };
